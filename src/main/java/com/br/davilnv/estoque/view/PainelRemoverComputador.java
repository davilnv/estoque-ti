...
public class PainelRemoverComputador extends PainelPadrao{
	...
	private JButton confirmarRemocaoButton, buscarButton;
	...
	public PainelRemoverComputador(String titulo){
		...
		confirmarRemocaoButton = new JButton("Confirmar Remoção");
		confirmarRemocaoButton.setBackground(Color.WHITE);
		confirmarRemocaoButton.setFont(new Font("Arial", Font.BOLD, 10));
		confirmarRemocaoButton.setBounds(230, 178, 140, 30);
	...
	public JButton getConfirmarRemocaoButton() {
		return confirmarRemocaoButton;
	}
